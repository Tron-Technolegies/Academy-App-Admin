...
import useGetSingleQuiz from "../../../hooks/quiz/useGetSingleQuiz";
...
const EditQuizForm = () => {
  ...
  const { quiz, loading: loadingQuiz } = useGetSingleQuiz(id);
  const { updateQuiz, loading: updating } = useUpdateQuiz();
  ...
  return (
    <form onSubmit={handleSubmit} className="pt-4 space-y-6">
      <h4 className="text-[#4F4F4F] text-3xl p-6 font-semibold">Edit Quiz</h4>
